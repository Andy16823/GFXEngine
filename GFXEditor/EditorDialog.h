...
namespace GFXEditor {
	...
	public:
		...
		// Parameter: EditorDialogCallback callback - the callback wich gets performed on success
		// Remarks: Opens the dialog and calls the callback when the ok button get pressed.
		//************************************
