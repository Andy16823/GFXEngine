...
void GFXEngine::Graphics::InstancedGeometryPipeline::create(LibGFX::VkContext& context)
{
	...
	m_instanceDataLayout = layoutBuilder.addBinding(0, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, VK_SHADER_STAGE_VERTEX_BIT)
		.build(context);
	layoutBuilder.clear();
	...
	std::array<VkDescriptorSetLayout, 3> descriptorSetLayouts = { m_uniformsLayout, m_textureLayout, m_instanceDataLayout };
...
void GFXEngine::Graphics::InstancedGeometryPipeline::destroy(LibGFX::VkContext& context)
{
	...
	if(m_instanceDataLayout != VK_NULL_HANDLE) {
		context.destroyDescriptorSetLayout(m_instanceDataLayout);
		m_instanceDataLayout = VK_NULL_HANDLE;
	}
}

VkPipeline GFXEngine::Graphics::InstancedGeometryPipeline::getPipeline() const
{
	return m_pipeline;
}

VkPipelineLayout GFXEngine::Graphics::InstancedGeometryPipeline::getPipelineLayout() const
{
