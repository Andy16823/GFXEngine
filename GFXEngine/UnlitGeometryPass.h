...
namespace GFXEngine {
	namespace Graphics {
		class UnlitGeometryPass : public IGraphicsPass
		{
		public:
			//************************************
			// Method:    buildLayout
			// FullName:  GFXEngine::Graphics::UnlitGeometryPass::buildLayout
			// Access:    public 
			...
			// FullName:  GFXEngine::Graphics::UnlitGeometryPass::bindResources
			// Access:    public 
			// Returns:   bool
			// Qualifier: const 
