...
void GFXEngine::Graphics::DebugPipeline::create(LibGFX::VkContext& context)
{
	...
	rasterizer.cullMode = VK_CULL_MODE_BACK_BIT; // TODO: Change
...
void GFXEngine::Graphics::DebugPipeline::destroy(LibGFX::VkContext& context)
{
